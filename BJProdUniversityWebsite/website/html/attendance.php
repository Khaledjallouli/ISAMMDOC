  ...
  <li class="backpage">
    ...
    <section  class="course-concern" >
            ...
            <div class="container " >
               ...
               <li class="active"><a href="#lstudentslist" role="tab" data-toggle="tab">Student's List </a></li>
                ...
                <div class="tab-content">
                      ...
                      <?php
                         $sqlli="SELECT * FROM member
        left JOIN course ON course.c_level = member.m_level and course.c_cat = member.m_cat where c_id = $key and m_groupnb =$nb "; 

                          
                                 $resul=mysqli_query($conn,$sqlli);
                        ...
                        <table class="mc-table">
                                <thead >
                                  <tr>
									...
									<th class="latest-reply"><span class="gris">Present</span></th>
                          ...
                          <?php
                             ...
                             <tr> 
                         <form method="post" action="<?php echo "saveattendance.php?c_id=".$key."&group_nb=".$nb ?>">  
                        ...
                        <div class="image"> 
                                <?php  if (!empty($row1["m_Pic"] )){ 
                                 echo "<img src='images/".$pic."'>" ;}
                                  ...
                                  <td class="submission">  <a href="<?php echo "profile.php?m_nId=".$nid."" ?>"> <?php echo $name ?> </a>
                              </td>
                                                          


                              <td class="submissions"><?php echo $nid ?></td>
...
<label for="<?php echo "input-2".$nid."" ?>"></label>
<input id="<?php echo "input-2".$nid."" ?>" name="<?php echo "attend".$nid."" ?>" value="Absent"  type="checkbox" >
                    ...
                    <input type="submit" value="Submit" name="submit" class="mc-btn btn-style-1 pull-right">
                     
              			  </div>   
              			   </form>
                  
                              <?php }             else {?> <table class="mc-table">
                                              <tr> 
