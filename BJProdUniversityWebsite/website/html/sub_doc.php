                   ...
                   <div>
                    ...
                    if(mysqli_num_rows($resule))
                        ...
                        <table class="mc-table">
                                <thead >
                                  <tr >
                                    <th class="submissions"><span class="gris">&ensp;&ensp; <br>Groups </span></th>
                          ...
                          <?php
                             ...
                             <tr> 
                               <td>
                                ...
                                <a href="<?php echo "listsub_doc.php?c_id=".$timely."&d_id=".$iid."&group_nb=".$nb ?>" > 
                         ...
                         <?php } }  
                                         else {?><ul class="nav-tabs" role="tablist">
                
               <li class="active"><a href="#examgrade" role="tab" data-toggle="tab">Groups</a></li>
                 </ul>
                 <table class="mc-table">
                                              <tr> 
