    ...
    <section  class="course-concern" >
            ...
            <div class="container " >
                ...
                <div class="tab-content">
                      ...
                      <?php
                                               $sqll ="SELECT * FROM grade 



  left JOIN member ON grade.m_nId = member.m_nId  where m_groupnb=$nb and c_id =$key "; 
                                 $resul=mysqli_query($conn,$sqll);
                    if(mysqli_num_rows($resul)){ ?> 

                 <ul class="nav-tabs" role="tablist">
                
               <li class="active"><a href="#examgrade" role="tab" data-toggle="tab">Student's List</a></li>
                 </ul>
  <form method="post" action="<?php echo "savegrade.php?c_id=".$key."&group_nb=".$nb ?>">  

                        <table class="mc-table">
                                <thead >
                                  <tr>
                                       <th class="info-author"><span class="gris">&ensp;&ensp;&ensp; Avatar</span></th>
                                    <th class="submission"><span class="gris">Student Name</span></th>   
                                    <th class="submissions"><span class="gris">Student National ID </span></th>
                                   
									<th class="latest-reply"><span class="gris">Midterm 1 Grade</span></th>
                                    <th class="latest-reply1"><span class="gris">Midterm 2 Grade</span></th>

                  <th class="latest-reply2"><span class="gris">Final Exam Grade</span></th>
                          ...
                          <?php
                                     ...
                                     {  $name = $row1['m_fName']." ".$row1['m_lName'] ;
  										 $nid= $row1['m_nId'];
  										 $pic = $row1['m_Pic'];
                                ...
                                <?php  if (!empty($row1["m_Pic"] )){ 
                                 echo "<img src='images/".$pic."'>" ;}
                                    if (empty($row1["m_Pic"] )){ 
                                       ...
                                       <img width="50px" height="50px" src="images/female.png" /> 
                                            <?php  }
                                            else  if ($row1["m_gender"]=='Male'){ ?>
                                         <img  width="50px" height="50px" src="images/male.jpg" /> 
                                            <?php  } 
                                            else {  ?>
                                       <img   width="50px" height="50px" src="images/male.jpg" /> 
                                            <?php }  } ?> &ensp;&ensp;
                                  ...
                                  <td class="submission" width="175px">   
                                    <input type="hidden" name="g_id[]" value="<?php echo $row1['g_id']; ?>" >
                                  <a href="<?php echo "profile.php?m_nId=".$nid."" ?>"><?php echo $name ?> </a>
                              </td>
                                                          

                              <td class="submissions"> <?php echo $nid  ; ?>
                             </td>
                                 


                             <td class="latest-reply">
                             <input class="uk-input uk-form-width-medium" type="text" name="g_midt1[]" value="<?php echo $row1['g_midt1'];?>" />
                             </td> 
                             <td class="latest-reply1">
                             <input class="uk-input uk-form-width-medium" type="text" name="g_midt2[]" value="<?php echo $row1['g_midt2'];?>" />
                             </td> 
                             <td class="latest-reply2">
                             <input class="uk-input uk-form-width-medium" type="text" name="g_finalexam[]" value="<?php echo $row1['g_finalexam'];?>" />
                             </td> 
                   ...
                   <div class="input-save">   
                      <input type="submit"  class="mc-btn btn-style-1 pull-right"  value="Submit" name="submit"> 
                       ...
                       </form><?php } else {?>  <ul class="nav-tabs" role="tablist">
               ...
               <li class="active"><a href="#examgrade" role="tab" data-toggle="tab">Student's List</a></li>
                 ...
                 <table class="mc-table">
                             ...
                             There is no student in this group of  <b><?php  echo "$cname" ?></b> course
