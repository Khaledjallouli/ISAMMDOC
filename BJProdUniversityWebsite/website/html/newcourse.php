            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="create-course-sidebar">
                            <ul class="list-bar">
                                <li class="active"><span class="count"><img src="images/add1.png" width="15px"></span>New Course</li>
                ...
                <div class="col-md-9">
                    ...
                    <form id="loginForm" method="get" action="savecourse.php">
                        <!-- COURSE BANNER -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="form-group">
                                      <input type="text" class="form-control" name ="c_fullname" placeholder="Course full name"  required >
                                    </div>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="course-banner create-item">
                            <div class="row">
                                <div class="col-md-3">
                                   ...
                                   <div class="col-lg-9">
                                    <div class="form-group">
                                      <input type="text" class="form-control"  name ="c_code" placeholder="Course code" required >
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="description create-item">
                            <div class="row">
                                 ...
                                 <div class="col-lg-9">
                                    <div class="form-group">
                                      <input type="text" class="form-control" name ="c_credit" placeholder="Course credit" required >
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-9">
                                    <div class="form-item form-radio radio-style">
                                        <input type="radio" id="beginer" value="1" name="c_level"  required>
                                        <label for="beginer">
                                    ...
                                    <div class="form-item form-radio radio-style">
                                        ...
                                        <input type="radio" id="intermediate" value="2"  name="c_level" required>
                                        ...
                                        <input type="radio" id="final" value="3"  name="c_level" required>
                                        <label for="final">
                                            <i class="icon-radio" style="float: left"></i>
                                ...
                                <div class="col-md-9">
                                    <table class="table-categories">
                                        <tr>
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="business" value="IM" name="c_cat">
                                                    <label for="business">
                                            ...
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="lifestyle" value="CM" name="c_cat">
                                                    <label for="lifestyle">
                                                        <i class="icon-checkbox icon md-check-1" style="float: left"></i>
                                            ...
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="game" value="AV" name="c_cat">
                                                    <label for="game">
                                                        <i class="icon-checkbox icon md-check-1" style="float: left"></i>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="design" value="3D" name="c_cat">
                                                    <label for="design">
                                                        <i class="icon-checkbox icon md-check-1" style="float: left"></i>
                                            ...
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="math-and-science" value="JV" name="c_cat">
                                            ...
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="crafts-and-hobbies" value="Engineering" name="c_cat">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="photography" value="Research Master" name="c_cat" >
                                            ...
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="education" value="Professional Master" name="c_cat" >
                                                    <label for="education">
                                                        <i class="icon-checkbox icon md-check-1" style="float: left"></i>
                                            ...
                                            <td>
                                                <div class="form-item form-checkbox checkbox-style">
                                                    <input type="radio" id="music" value="Production Master" name="c_cat">
                                                    <label for="music">
                                                        <i class="icon-checkbox icon md-check-1" style="float: left"></i>
                        ...
                        <div class="for-level-from create-item">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-item form-radio radio-style">
                                        <input type="radio" id="health" name ="c_reviewsystem" value="Continuous Evaluation">
                                        <label for="health">
                                            <i class="icon-radio" style="float: left"></i>
                                           <span style="float: right;color:gray">Continuous Evaluation </span>
                                        </label>
                                    </div>

                                    <div class="form-item form-radio radio-style">

                                        <input type="radio" id="social-science" name ="c_reviewsystem" value="Mixed System">
                                        <label for="social-science">
                                            <i class="icon-radio" style="float: left"></i>
                                             <span style="float: right;color:gray">Mixed System</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="course-banner create-item">
                            <div class="row">
                                <div class="col-md-3">
                                 ...
                                 <div class="col-lg-9">
                                    <div class="form-group">
                                      <input type="text" class="form-control" name ="c_totalabsence" placeholder="Total number of absences allowed" required >
                                    </div>
                                </div>
                            </div>
                        </div>
