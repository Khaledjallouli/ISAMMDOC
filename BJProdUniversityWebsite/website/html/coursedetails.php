                                 ...
                                 <a href="<?php echo "download.php?d_id=".$id."" ?>">
                                    <i class="material-icons dp48" style="color:#3a7ff5 ">play_for_work</i>
                                      ...
                                      <div class="uk-offcanvas-bar" style="background-color: #024A87">
                                        ...
                                        <img src="images/PJ1.png" width="40px" height="40px">&ensp;&ensp;Attached practical work 
                                         <?php echo "<br><br>";
                                      $query="SELECT * from practical_work where d_id=$id order by td_id desc"  ;
                                       $res=mysqli_query($conn,$query);
                                        ...
                                        <?php    }  } else { ?>
                                            <div id="no">There is no practical work posted </div><br>
                                        <?php } ?>
                              ...
                              <td class="latest-reply">
                                 ...
                                 <div id="offcanvas-reveal<?php echo $id ?>" uk-offcanvas="mode: reveal; overlay: true">
                                      <div class="uk-offcanvas-bar" style="background-color: #024A87">
                                        ...
                                        <h3>Title</h3>
                                        <h4><?php echo $row1["d_title"] ?></h4>
                                        <img src="images/PJ1.png" width="40px" height="40px">&ensp;&ensp;Attached practical work <br>
                                         <?php 
                                      $query="SELECT * from practical_work where d_id=$id order by td_id desc"  ;
                                       $res=mysqli_query($conn,$query);
                                        if(mysqli_num_rows($res))
                                      ...
                                      <?php $query="SELECT * from practical_work where d_id=$id order by td_id desc"  ;
                                       $res=mysqli_query($conn,$query);
                                        $r=mysqli_fetch_assoc($res);
                                            $tdid=$r['td_id'];
                                            $tdname=$r['td_title'];
                                            $tdfile=$r['td_file']; ?>
                                      <div id="no" style='margin-left:45px;'><br>There is no practical work <br></div>
                              ...
                              <td class="latest-reply">
                                 <a href="<?php echo "download.php?d_id=".$id."" ?>">
                                    <i class="material-icons dp48" style="color:#3a7ff5 ">play_for_work</i>
                                        ...
                                        <td >
                                            <a href="#"  title="Edit"  >
                                            <i class="icon md-edit " style="font-size:15px; color:#139DF0" ></i></a>
                                        </td>
                                        <td >
